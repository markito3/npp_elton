...
//
  ...
  char string[256];
    ...
    TH1F *M2piacc_g1V00ic = (TH1F*)f->Get("M2piacc_g1V00ic");
    ...
    TH1F *theta_scatacc_g1V00ic = (TH1F*)f->Get("theta_scatacc_g1V00ic");
    ...
    TH1F *cosThetaacc_g1V00ic = (TH1F*)f->Get("cosThetaacc_g1V00ic");
    ...
    TH1F *Phiacc_g1V00ic = (TH1F*)f->Get("Phiacc_g1V00ic");
   ...
   c0->Divide(3,2);
    ...
    // M2piacc_g1V00ic->SetLineColor(3);
    // M2piacc_g1V00ic->Draw("same");
    ...
    // leg2->AddEntry(M2piacc_g1V00ic,"Incoherent","lp");
    leg2->AddEntry(M2piInt,"Inteference","lp");
    leg2->Draw();

    
    ymin=0;
    ymax=1500*4/scale_factor;
    ...
    // theta_scatacc_g1V00ic->SetLineColor(3);
    // theta_scatacc_g1V00ic->Draw("same");
    ...
    cout << " Integrals: Data=" << sum_data << " g1V00=" << sum_g1V00 << " g1V00s=" << sum_g1V00s << " sum_Int=" << sum_Int << endl;
    cout << " Fractions: Data=" << sum_data/sum_g1V00 << " g1V00=" << sum_g1V00/sum_g1V00 << " g1V00s=" << sum_g1V00s/sum_g1V00 << " sum_Int=" << sum_Int/sum_g1V00 << endl;
    ...
    // cosThetaacc_g1V00ic->SetLineColor(3);
    // cosThetaacc_g1V00ic->Draw("same");
