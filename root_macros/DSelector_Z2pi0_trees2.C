#include "DSelector_Z2pi0_trees2.h"

void DSelector_Z2pi0_trees2::Init(TTree *locTree)
{
	...
	dOutputFileName = "DSelector_Z2pi0_trees2.root"; //"" for none
	dOutputTreeFileName = "tree_DSelector_Z2pi0_trees.root"; //"" for none
	dFlatTreeFileName = "treeFlat_DSelector_Z2pi0_trees.root"; //output flat tree (one combo per tree entry), "" for none
	dFlatTreeName = "pi0pi0misspb208_TreeFlat"; //if blank, default name will be chosen
	...
	dHist_gthetalab = new TH1I("gthetalab", ";Photon Angle Lab (degrees)", 90,0,30);
	dHist_gthetalab_Eg = new TH2I("gthetalab_Eg", "; Photon Energy (GeV) ; Photon Angle Lab (degrees)",100,0,4,90,0,30 );
...
Bool_t DSelector_Z2pi0_trees2::Process(Long64_t locEntry)
{
	...
	set<Int_t> locUsedSoFar_Photon; // Int_t list of photons used. Use generated photons so that Int_t pointer can be used.
	...
	*/
	...
	TLorentzVector locPhoton1P4_Thrown;
	TLorentzVector locPhoton2P4_Thrown;
	TLorentzVector locPhoton3P4_Thrown;
	TLorentzVector locPhoton4P4_Thrown;
	for(UInt_t loc_i = 0; loc_i < Get_NumThrown(); ++loc_i)
	{
		...
		if (loc_i == 0) locPb208P4_Thrown = locP4_Thrown;    // Assume recoil is index 0
		if (loc_i == 1) locPhoton1P4_Thrown = locP4_Thrown;
		if (loc_i == 2) locPhoton2P4_Thrown = locP4_Thrown;
		if (loc_i == 3) locPhoton3P4_Thrown = locP4_Thrown;
		if (loc_i == 4) locPhoton4P4_Thrown = locP4_Thrown;
		
	}
	TLorentzVector locDecayingPi01P4_Thrown = locPhoton1P4_Thrown + locPhoton2P4_Thrown;     // Assume that Pi01 comes from Photon1 + Photon 2
	TLorentzVector locDecayingPi02P4_Thrown = locPhoton3P4_Thrown + locPhoton4P4_Thrown;     // Assume that Pi01 comes from Photon3 + Photon 4

	TLorentzVector locMissingP4_Thrown = dThrownBeam->Get_P4();    // Ignore target mass/recoil 
	TLorentzVector loc2piP4_Thrown = locPhoton1P4_Thrown + locPhoton2P4_Thrown + locPhoton3P4_Thrown + locPhoton4P4_Thrown;
	locMissingP4_Thrown -= loc2piP4_Thrown;

	cout << endl << "Thrown" << endl;  
	cout << " dThrownBeam="; dThrownBeam->Get_P4().Print();
	cout << " locPb208P4="; locPb208P4_Thrown.Print();
	cout << " Mass=" << locDecayingPi01P4_Thrown.M() << " locDecayingPi01P4="; locDecayingPi01P4_Thrown.Print();
        cout << " Mass=" << locDecayingPi02P4_Thrown.M() << " locDecayingPi02P4="; locDecayingPi02P4_Thrown.Print();
	cout << " locPhoton1P4="; locPhoton1P4_Thrown.Print();
	cout << " locPhoton2P4="; locPhoton2P4_Thrown.Print();
	cout << " locPhoton3P4="; locPhoton3P4_Thrown.Print();
	cout << " locPhoton4P4="; locPhoton4P4_Thrown.Print();
	...
	for(UInt_t loc_i = 0; loc_i < Get_NumCombos(); ++loc_i)
	{
		...
		TLorentzVector loc2piP4 = locPhoton1P4 + locPhoton2P4 + locPhoton3P4 + locPhoton4P4;
		locMissingP4 -= loc2piP4;


		cout << endl << "Kin Fit jcombo=" << loc_i << endl; 
		cout << " locBeamP4="; locBeamP4.Print();
		cout << " locMissingPb208P4="; locMissingPb208P4.Print();
		cout << " Mass=" << locDecayingPi01P4.M() << " locDecayingPi01P4="; locDecayingPi01P4.Print();
		cout << " Mass=" << locDecayingPi02P4.M() << " locDecayingPi02P4="; locDecayingPi02P4.Print();
		cout << " locPhoton1P4="; locPhoton1P4.Print();
		cout << " locPhoton2P4="; locPhoton2P4.Print();
		cout << " locPhoton3P4="; locPhoton3P4.Print();
		cout << " locPhoton4P4="; locPhoton4P4.Print();
		...
		TLorentzVector locDecayingPi01P4_Measured = locPhoton1P4_Measured + locPhoton2P4_Measured;     // cheat a little because I'm not doing combinatorics on the photons.
		//Step 2
		...
		TLorentzVector locDecayingPi02P4_Measured = locPhoton3P4_Measured + locPhoton4P4_Measured;     // cheat a little because I'm not doing combinatorics on the photons.
		...
		TLorentzVector loc2piP4_Measured = locPhoton1P4_Measured + locPhoton2P4_Measured + locPhoton3P4_Measured + locPhoton4P4_Measured;
		locMissingP4_Measured -= loc2piP4_Measured;
		...
		cout << " Mass=" << locDecayingPi01P4_Measured.M() << " locDecayingPi01P4="; locDecayingPi01P4_Measured.Print();
		cout << " Mass=" << locDecayingPi02P4_Measured.M() << " locDecayingPi02P4="; locDecayingPi02P4_Measured.Print();
		cout << " locPhoton1P4_Measured="; locPhoton1P4_Measured.Print();
		cout << " locPhoton2P4_Measured="; locPhoton2P4_Measured.Print();
		cout << " locPhoton3P4_Measured="; locPhoton3P4_Measured.Print();
		cout << " locPhoton4P4_Measured="; locPhoton4P4_Measured.Print();
		cout << " locMissingP4_Measured="; locMissingP4_Measured.Print();
		cout << " loc2piP4_Measured="; loc2piP4_Measured.Print();
		cout << "Measured: MM2 =" << locMissingP4_Measured.M2() << " DeltaE=" << locBeamP4.E()-loc2piP4_Measured.E() << " GenDeltaE=" << locEbeam_Thrown-locBeamP4_Measured.E() << endl;
		...
		*/
		...
		locUsedThisCombo_2piMass[Gamma].insert(locPhoton3NeutralID);
		locUsedThisCombo_2piMass[Gamma].insert(locPhoton4NeutralID);
		...
		cout << "Photon1 Thrown P4.E=" << locPhoton1P4_Thrown.E() << " Kinfit P4.E=" << locPhoton1P4.E() << " P4 Measured =" << locPhoton1P4_Measured.E() << endl;
		...
		//Histogram photon angle (if haven't already)
		if(locUsedSoFar_Photon.find(locPhoton1NeutralID) == locUsedSoFar_Photon.end())
		{
		        dHist_gthetalab->Fill(locPhoton1P4.Vect().Theta()*180/3.14159);
			dHist_gthetalab_Eg->Fill(locPhoton1P4.E(),locPhoton1P4.Vect().Theta()*180/3.14159);
			locUsedSoFar_Photon.insert(locPhoton1NeutralID);
		}
		if(locUsedSoFar_Photon.find(locPhoton2NeutralID) == locUsedSoFar_Photon.end())
		{
		        dHist_gthetalab->Fill(locPhoton2P4.Vect().Theta()*180/3.14159);
			dHist_gthetalab_Eg->Fill(locPhoton2P4.E(),locPhoton2P4.Vect().Theta()*180/3.14159);
			locUsedSoFar_Photon.insert(locPhoton2NeutralID);
		}
		if(locUsedSoFar_Photon.find(locPhoton3NeutralID) == locUsedSoFar_Photon.end())
		{
		        dHist_gthetalab->Fill(locPhoton3P4.Vect().Theta()*180/3.14159);
			dHist_gthetalab_Eg->Fill(locPhoton3P4.E(),locPhoton3P4.Vect().Theta()*180/3.14159);
			locUsedSoFar_Photon.insert(locPhoton3NeutralID);
		}
		if(locUsedSoFar_Photon.find(locPhoton4NeutralID) == locUsedSoFar_Photon.end())
		{
		        dHist_gthetalab->Fill(locPhoton4P4.Vect().Theta()*180/3.14159);
			dHist_gthetalab_Eg->Fill(locPhoton4P4.E(),locPhoton4P4.Vect().Theta()*180/3.14159);
			locUsedSoFar_Photon.insert(locPhoton4NeutralID);
		}
		...
		locUsedThisCombo_Angles[Gamma].insert(locPhoton3NeutralID);
		locUsedThisCombo_Angles[Gamma].insert(locPhoton4NeutralID);
		...
		TLorentzVector p1_res = resonanceBoost * locDecayingPi01P4_Thrown;
		TLorentzVector p2_res = resonanceBoost * locDecayingPi02P4_Thrown;
                ...
                // choose helicity frame: z-axis opposite recoil target in rho rest frame. Note that for Primakoff recoil is never measured. Also for pi0 this code may not be interesting
		...
		p1_res = resonanceBoost2 * locDecayingPi01P4;
		p2_res = resonanceBoost2 * locDecayingPi02P4;
		...
		p1_res = resonanceBoost3 * locDecayingPi01P4_Measured;
		p2_res = resonanceBoost3 * locDecayingPi02P4_Measured;
...
void DSelector_Z2pi0_trees2::Finalize(void)
{
