...
//
  ...
  // TString filename = "DSelector_Z2pi_trees_signal";
    ...
    TH1F *gthetalab = (TH1F*)f->Get("gthetalab");
    TH2F *gthetalab_Eg = (TH2F*)f->Get("gthetalab_Eg");
   ...
   c0->Divide(3,2);
    ...
    c4->cd(4);
    gthetalab->SetTitle(filename);
    // gthetalab->GetXaxis()->SetRangeUser(xmin,xmax);
    // gthetalab->GetYaxis()->SetRangeUser(ymin,ymax);
    gthetalab->GetXaxis()->SetTitleSize(0.05);
    gthetalab->GetYaxis()->SetTitleSize(0.05);
    gthetalab->GetXaxis()->SetTitle("All Photon Lab Angles (deg)");
    gthetalab->SetMarkerColor(4);
    gthetalab->Draw();

    c4->cd(5);
    gthetalab_Eg->SetTitle(filename);
    // gthetalab_Eg->GetXaxis()->SetRangeUser(xmin,xmax);
    // gthetalab_Eg->GetYaxis()->SetRangeUser(ymin,ymax);
    gthetalab_Eg->GetXaxis()->SetTitleSize(0.05);
    gthetalab_Eg->GetYaxis()->SetTitleSize(0.05);
    gthetalab_Eg->GetXaxis()->SetTitle("All Photon Energies (GeV)");
    gthetalab_Eg->GetYaxis()->SetTitle("All Photon Lab Angles (deg)");
    // gthetalab_Eg->SetMarkerColor(4);
    gthetalab_Eg->Draw("colz");
